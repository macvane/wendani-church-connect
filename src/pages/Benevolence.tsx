                ...
                <form ref={formRef} onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600 mb-3">
                      Please indicate whether this is a new benevolence registration or an update to existing details.
                    </p>
                  ...
                  <div>
                    <h3 className="text-lg font-bold mb-4 border-b border-gray-200 pb-2">Principal Member Information</h3>
                  ...
                  <div>
                    ...
                    <div className="bg-blue-50 p-4 rounded-md border border-blue-200 mb-4">
                      ...
                      <ul className="list-disc pl-5 text-blue-800 text-sm space-y-1">
                        <li>Children of the registred members who are below 18 years, or those above 18 years who are in school or college</li>
                          <li>Biological parent or registered guardian of the fund members</li>
                          <li>Any other special case that may be considered by the committee and approved by the special church business meeting of Fund members through a simple majority vote</li>
                      </ul>
                    </div>
                  ...
                  <div className="bg-yellow-50 p-4 rounded-md border border-yellow-200">
                    ...
                    <ul className="list-disc pl-5 text-yellow-800">
                      <li><span className='font-semibold'>Registration fee:</span> of KES.500 is applicable for new members (M-Pesa No:0114220367)</li>
                      <li><span className='font-semibold'>Contributions:</span> Members are required to make contributions every time a member is bereaved</li>
                      <li><span className='font-semibold'>Benefit:</span> The committee shall give a total of KES.50,000 (Fifty Thousand), to the bereaved family. The bereaved members hsould not have defaulted the past 3 consecutive cases.</li>
                    </ul>
                  </div>


                  <div className="p-4 border rounded-md">
                    <h3 className="text-lg font-semibold mb-4 text-gray-800">Signature</h3>
                    <p>My signature below guarantees the information provided above is accurate and true.</p>

                    <div className='grid grid-cols-2 gap-2 mt-2' >
                      <div className="">
                        <label htmlFor="signatureName" className="block font-medium mb-1 text-gray-700">Full Name <span className="text-red-500">*</span></label>
                        <input type="text" id="signatureName" name="signatureName" required placeholder="Full Name" className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-church-600 focus:border-transparent" />
                      </div>

                      <div>
                        <label htmlFor="signatureDate" className="block font-medium mb-1 text-gray-700">Date</label>
                        <input type="date" id="signatureDate" name="signatureDate" value={today} min={today} max={today} readOnly className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-church-600 focus:border-transparent" />
                      </div>
                    </div>
                  </div>
