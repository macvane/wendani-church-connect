    ...
    <section className="w-full py-16 bg-church-900 text-white">
      <div className="w-[90%] mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-0">
        ...
        <div className="flex justify-center items-center space-x-4 md:space-x-8">
          {timerComponents.length ? timerComponents : <div className="text-2xl md:text-4xl font-bold text-center flex flex-col justify-center items-center space-y-2"><p>The camp meeting has begun!</p><p className='font-normal text-2xl animate-pulse hover:text-church-500 cursor-pointer'><a href="https://www.youtube.com/live/voo77OCqjlc?si=YF22xlf9BRrXCqnW" target='_blank'>Watch Live</a></p></div>}
        </div>
      </div>
    </section>
  );
